...
import discretescrollview.transform.DiscreteScrollItemTransformer;
    ...
    protected void layoutView(RecyclerView.Recycler recycler, int position, Point viewCenter) {
        ...
        if (v == null) {
            ...
            recyclerViewProxy.layoutDecoratedWithMargins(v,
                    viewCenter.x - childHalfWidth - 30, viewCenter.y - childHalfHeight,
                    viewCenter.x + childHalfWidth + 30, viewCenter.y + childHalfHeight);
        } else {
