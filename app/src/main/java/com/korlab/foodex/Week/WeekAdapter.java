package com.korlab.foodex.Week;
...
//    public ProgramDayAdapter(Context context) {
//        mContext = context;
//    }

    public WeekAdapter(LayoutInflater inflater, List<ProgramDay> data) {
        this.data = data;
...
//        max = data.size()-1;
    ...
    public Object instantiateItem(@NonNull ViewGroup container, int position) {
        View view = inflater.inflate(R.layout.item_week_day, container, false);
...
////        return view;
        ...
        ProgramDay item = data.get(position);
        if(item != null) {
            Helper.log(position+": ");
            ...
            name.setText(item.getMeals().get(0).getDishList().get(0).getName());
