package com.korlab.foodex.UI.DatePicker;
...
//        }
        ...
        Helper.log("==================");
        Helper.log("year: " + year);
        Helper.log("month: " + month);
        Helper.log("daysInMonth: " + daysInMonth);



        Calendar calendarOld = new GregorianCalendar();
        calendarOld.setFirstDayOfWeek(Calendar.MONDAY);
        if(month != 10)
            calendarOld.set(year, month, 1);
        else
            calendarOld.set(year, month, 1);
        int maxWeeknumber = calendarOld.getActualMaximum(Calendar.WEEK_OF_MONTH);
        int dayOfWeek;
        ...
        Helper.log("maxWeeknumber: " + maxWeeknumber);
        Helper.log("dayOfWeek: " + dayOfWeek);
        Helper.log("==================");
